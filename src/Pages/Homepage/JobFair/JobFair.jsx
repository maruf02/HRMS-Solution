  ...
  return (
    <div className="pl-10">
      <div className="text-center  py-14">
        <h2 className="text-[#00b359] text-2xl ">
          Start Your Career With Our{" "}
        </h2>
        <h2 className="text-[#00b359] text-5xl font-bold ">JOB Fair!!</h2>
          ...
          >
            <div className="card w-full   shadow-xl">
              ...
              <div className="card-body items-center text-center">
                <p>{/* <FaQuoteLeft className="text-5xl" /> */}</p>
      ...
      <Link to="/jobs">
        <div className="flex justify-center pt-5 pb-14">
          <p className=" text-2xl text-white font-bold">See All Job's</p>
          <p>
            <FaArrowCircleRight className="mt-3 ml-2 text-white text-lg "></FaArrowCircleRight>
          </p>
        </div>
      </Link>
    </div>
