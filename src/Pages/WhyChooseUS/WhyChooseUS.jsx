    ...
    <div className="py-10">
      <div className="pb-10">
        ...
        <h2 className="text-center font-display text-3xl font-bold tracking-tight text-lime-500 md:text-4xl">
          Dedicated to delivering cutting-edge technology services
        </h2>
      </div>
      <div className="container mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start justify-center md:justify-between">
        <div className="grid gap-4 justify-items-center text-center md:flex-1">
          ...
          <h3 className="text-3xl font-bold">Safety-First</h3>
          <p>
            We prioritize your online safety with cyber Security specialist with
        ...
        <div className="grid gap-4 justify-items-center text-center md:flex-1">
          ...
          <p>Feel good about your System and the environment</p>
        </div>
        <div className="grid gap-4 justify-items-center text-center md:flex-1">
          <div className=" rounded-full border-8 border-amber-400 p-4 ">
            <svg
          ...
          <p>
            We thrive on innovation, constantly seeking new and creative
        ...
        <div className="grid gap-4 justify-items-center text-center md:flex-1">
          ...
          <h3 className="text-3xl font-bold">Integrity </h3>
          <p>
            Integrity is the cornerstone of our business. We are committed to
        ...
        <div className="grid gap-4 justify-items-center text-center md:flex-1">
          ...
          <h3 className="text-3xl font-bold">Client Approach</h3>
          <p>
            Our clients are at the heart of everything we do. We are dedicated
            to understanding their unique challenges{" "}
          </p>
        </div>
      </div>
    </div>
